---
name: render-deploy
description: Deploy applications on Render. Use when the user asks for render.yaml generation, repo-backed service setup, or deployment and status links for Render services.
---
